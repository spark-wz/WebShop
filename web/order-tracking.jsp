...
<head>
    ...
    <title>Tracking | Inspina E-Commerce HTML Template</title>
...
<div class="offcanvas-wrapper">
    ...
    <div class="container padding-top-1x padding-bottom-3x">
        <div class="card mb-3">
            <div class="p-4 text-center text-white text-lg bg-dark rounded-top"><span class="text-uppercase">Tracking Order No - </span><span class="text-medium">25698547569</span></div>
            <div class="d-flex flex-wrap flex-sm-nowrap justify-content-between py-3 px-2 bg-secondary">
                <div class="w-100 text-center py-1 px-2"><span class='text-medium'>Shipped Via:</span> Inspina Ground</div>
                <div class="w-100 text-center py-1 px-2"><span class='text-medium'>Status:</span> Checking Quality</div>
                <div class="w-100 text-center py-1 px-2"><span class='text-medium'>Expected Date:</span> JUNE 09, 2018</div>
            </div>
            <div class="card-body">
