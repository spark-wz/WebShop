...
<head>
    ...
    <title>Categories | Inspina E-Commerce HTML Template</title>
            ...
            <li class="active">
                ...
                <ul class="sub-menu">
                    <li class="has-children active">
                        ...
                        <ul class="sub-menu">
                            <li><a href="shop-categories-1.html">Categories Left Sidebar</a></li>
                            <li class="active"><a href="shop-categories-2.html">Categories Right Sidebar</a></li>
                            <li><a href="shop-categories-3.html">Categories No Sidebar</a></li>
                        </ul>
                    </li>
                    <li class="has-children">
...
<div class="offcanvas-wrapper">
    ...
    <div class="page-title">
        <div class="container">
            <div class="column">
                <h1>Shop Categories Right Sidebar</h1>
            </div>
            <div class="column">
                <ul class="breadcrumbs">
                    ...
                    <li>Shop Categories Right Sidebar</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container padding-top-1x padding-bottom-2x">
        <div class="row">
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="card mb-30">
                            <a class="card-img-tiles" href="shop-grid-1.html">
                                <div class="inner">
                                    <div class="main-img">
                            ...
                            <div class="card-body text-center">
                                ...
                                <a class="btn btn-outline-primary btn-sm" href="shop-list-1.html">View Products</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="card mb-30">
                            ...
                            <div class="card-body text-center">
                                ...
                                <p class="text-muted">Starting from $560</p>
                                <a class="btn btn-outline-primary btn-sm" href="shop-list-1.html">View Products</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="card mb-30">
                            ...
                            <div class="card-body text-center">
                                ...
                                <p class="text-muted">Starting from $249</p>
                                <a class="btn btn-outline-primary btn-sm" href="shop-list-1.html">View Products</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="card mb-30">
                            ...
                            <div class="card-body text-center">
                                ...
                                <p class="text-muted">Starting from $579</p>
                                <a class="btn btn-outline-primary btn-sm" href="shop-list-1.html">View Products</a>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Start Sidebar -->
            <div class="col-lg-3 order-lg-2 hidden-md-down">
                <aside class="sidebar">
                    ...
                    <section class="widget widget-categories">
                        ...
                        <ul>
                            <li><a href="shop-grid-1.html">Apple</a><span>(254)</span></li>
                            <li><a href="shop-grid-1.html">Samsung</a><span>(39)</span></li>
                            <li><a href="shop-grid-1.html">Sony</a><span>(205)</span></li>
                            <li><a href="shop-grid-1.html">Panasonic</a><span>(128)</span></li>
                            <li><a href="shop-grid-1.html">Lenovo</a><span>(104)</span></li>
                            <li><a href="shop-grid-1.html">Asus</a><span>(217)</span></li>
                            <li><a href="shop-grid-1.html">Motorola</a><span>(95)</span></li>
                            <li><a href="shop-grid-1.html">Nokia</a><span>(310)</span></li>
                            <li><a href="shop-grid-1.html">Microsoft</a><span>(134)</span></li>
                            <li><a href="shop-grid-1.html">Zetra</a><span>(73)</span></li>
                            <li><a href="shop-grid-1.html">Android</a><span>(446)</span></li>
                            <li><a href="shop-grid-1.html">Google</a><span>(87)</span></li>
                            <li><a href="shop-grid-1.html">Facebook</a><span>(42)</span></li>
                            <li><a href="shop-grid-1.html">Yahoo</a><span>(289)</span></li>
                            <li><a href="shop-grid-1.html">Twitter</a><span>(68)</span></li>
                            <li><a href="shop-grid-1.html">Youtube</a><span>(205)</span></li>
                            <li><a href="shop-grid-1.html">Instagram</a><span>(128)</span></li>
                        </ul>
                    </section>
                    <!-- End Popular Brands -->
                    <!-- Start Promo Banner -->
