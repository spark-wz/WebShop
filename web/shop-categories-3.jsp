                ...
                <ul class="sub-menu">
                    <li class="has-children active">
                        ...
                        <ul class="sub-menu">
                            <li><a href="shop-categories-1.html">Categories Left Sidebar</a></li>
                            <li><a href="shop-categories-2.html">Categories Right Sidebar</a></li>
                            <li class="active"><a href="shop-categories-3.html">Categories No Sidebar</a></li>
                        </ul>
                    </li>
                    <li class="has-children">
                        <a href="#"><span>Shop Grid</span></a>
...
<div class="offcanvas-wrapper">
    ...
    <div class="page-title">
        <div class="container">
            <div class="column">
                <h1>Shop Categories No Sidebar</h1>
            </div>
            <div class="column">
                <ul class="breadcrumbs">
                    ...
                    <li>Shop Categories No Sidebar</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="container padding-top-1x padding-bottom-2x">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 shop-cat">
                <div class="card mb-30">
                    <a class="card-img-tiles" href="shop-grid-1.html">
                        <div class="inner">
                            <div class="main-img">
