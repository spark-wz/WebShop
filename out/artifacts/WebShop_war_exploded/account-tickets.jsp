...
<head>
    ...
    <title>Tickets | Inspina E-Commerce HTML Template</title>
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="text-right">
                    <button class="btn btn-primary margin-bottom-none" data-toggle="modal" data-target="#openTicket">New Ticket</button>
                </div>
            </div>
        </div>
    </div>
