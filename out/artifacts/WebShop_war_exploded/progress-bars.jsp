...
<head>
    ...
    <title>Progress | Inspina E-Commerce HTML Template</title>
...
<div class="offcanvas-container" id="mobile-menu">
    <a class="account-link" href="#">
        <div class="user-ava">
            <img src="assets/images/account/user-ava-md.jpg" alt="Tony Stark">
        </div>
        <div class="user-info">
        ...
        <ul>
            ...
            <li class=" active">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="active"><a href="progress-bars.html"><i class="fa fa-angle-right"></i> Progress Bar</a></li>
    ...
    <div class="container padding-bottom-3x">
        <div class="row">
            <div class="col-lg-9 col-md-9 offset-lg-1 offset-md-1">
                <h6 class="text-muted text-normal text-uppercase">Progress Thick with Labels</h6>
                <hr class="margin-bottom-1x">
                <div class="progress margin-bottom-1x">
                    <div class="progress-bar progress-bar-1" role="progressbar" aria-valuenow="55" aria-valuemin="0" aria-valuemax="100">55%</div>
                </div>
                <div class="progress margin-bottom-1x">
                    <div class="progress-bar bg-success progress-bar-2" role="progressbar" aria-valuenow="33" aria-valuemin="0" aria-valuemax="100">33%</div>
                </div>
                <div class="progress margin-bottom-1x">
                    <div class="progress-bar bg-info progress-bar-3" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">70%</div>
                </div>
                <div class="progress margin-bottom-1x">
                    <div class="progress-bar bg-warning progress-bar-4" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">50%</div>
                </div>
                <div class="progress">
                    <div class="progress-bar bg-danger progress-bar-5" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100">40%</div>
                </div>
                <h6 class="text-muted text-normal text-uppercase padding-top-2x mt-2">Progress Thin with Labels</h6>
                <hr class="margin-bottom-1x">
                <label class="text-medium">Delivery - 55%</label>
                <div class="progress margin-bottom-1x">
                    <div class="progress-bar progress-bar-01" role="progressbar" aria-valuenow="55" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <label class="text-medium">Consulting - 33%</label>
                <div class="progress margin-bottom-1x">
                    <div class="progress-bar bg-success progress-bar-02" role="progressbar" aria-valuenow="33" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <label class="text-medium">Personal shopper - 70%</label>
                <div class="progress margin-bottom-1x">
                    <div class="progress-bar bg-info progress-bar-03" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <label class="text-medium">Taxes refund - 70%</label>
                <div class="progress margin-bottom-1x">
                    <div class="progress-bar bg-warning progress-bar-04" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <label class="text-medium">Packaging damages - 40%</label>
                <div class="progress">
                    <div class="progress-bar bg-danger progress-bar-05" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <h6 class="text-muted text-normal text-uppercase padding-top-2x mt-2">Animated Stripes</h6>
                <hr class="margin-bottom-1x">
                <div class="progress margin-bottom-1x">
                    <div class="progress-bar progress-bar-striped progress-bar-animated progress-bar-1" role="progressbar" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="progress margin-bottom-1x">
                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-success progress-bar-2" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="progress margin-bottom-1x">
                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-info progress-bar-3" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="progress margin-bottom-1x">
                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-warning progress-bar-4" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <div class="progress">
                    <div class="progress-bar progress-bar-striped progress-bar-animated bg-danger progress-bar-5" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
            </div>
        </div>
    </div>
