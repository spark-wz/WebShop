...
<head>
    ...
    <title>Support | Inspina E-Commerce HTML Template</title>
        ...
        <ul>
            ...
            <li class=" active">
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="contacts.html">Contact Us</a></li>
                    <li><a href="team.html">Our Team</a></li>
                    <li class="active"><a href="faq.html">Support Page</a></li>
                    <li><a href="order-tracking.html">Order Tracking</a></li>
                    <li><a href="search-results.html">Search Results</a></li>
                    <li><a href="404.html">404 Page</a></li>
                    <li><a href="coming-soon.html">Coming Soon</a></li>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4">
                <nav class="list-group">
                    <a class="list-group-item active" href="#">Do FAQS improve usability?</a>
                    <a class="list-group-item" href="#">Are FAQS still in my future?</a>
                    <a class="list-group-item" href="#">Are FAQs ever appropriate?</a>
                    <a class="list-group-item" href="#">Is my FAQ doing what it should?</a>
                    <a class="list-group-item" href="#">What have I concluded?</a>
                    <a class="list-group-item" href="#">Which works have I cited?</a>
                    <a class="list-group-item" href="#">What is this product?</a>
                </nav>
            ...
            <div class="col-lg-9 col-md-8">
                <div class="accordion" id="accordion" role="tablist">
                    <div class="card">
                        <div class="card-header" role="tab">
                            <h6><a href="#collapseOne" data-toggle="collapse" data-parent="#accordion">Do FAQS improve usability?</a></h6>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header" role="tab">
                            <h6><a class="collapsed" href="#collapseTwo" data-toggle="collapse" data-parent="#accordion">Are FAQS still in my future?</a></h6>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header" role="tab">
                            <h6><a class="collapsed" href="#collapseThree" data-toggle="collapse" data-parent="#accordion">Are FAQs ever appropriate?</a></h6>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header" role="tab">
                            <h6><a class="collapsed" href="#collapseFour" data-toggle="collapse" data-parent="#accordion">Is my FAQ doing what it should?</a></h6>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header" role="tab">
                            <h6><a class="collapsed" href="#collapseFive" data-toggle="collapse" data-parent="#accordion">What have I concluded?</a></h6>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header" role="tab">
                            <h6><a class="collapsed" href="#collapseSix" data-toggle="collapse" data-parent="#accordion">Which works have I cited?</a></h6>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header" role="tab">
                            <h6><a class="collapsed" href="#collapseSeven" data-toggle="collapse" data-parent="#accordion">What is this product?</a></h6>
                        </div>
                ...
                <p class="text-muted mb-30">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's.</p>
                <!-- Start Question Form -->
