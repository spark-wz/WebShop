...
<head>
    ...
    <title>Single Ticket | Inspina E-Commerce HTML Template</title>
            ...
            <div class="col-lg-4">
                <aside class="user-info-wrapper">
                    <div class="user-cover account-details">
                        <div class="info-label" data-toggle="tooltip" title="You currently have 530 Reward Points to spend"><i class="icon-medal"></i>530 Points</div>
                    </div>
                    <div class="user-info">
                ...
                <nav class="list-group">
                    ...
                    <a class="list-group-item with-badge" href="account-orders.html"><i class="icon-bag"></i>My Orders<span class="badge badge-primary badge-pill">6</span></a>
                    <a class="list-group-item" href="account-address.html"><i class="icon-map"></i>My Addresses</a>
                    <a class="list-group-item with-badge" href="account-wishlist.html"><i class="icon-heart"></i>My Wishlist<span class="badge badge-primary badge-pill">3</span></a>
                    <a class="list-group-item active with-badge" href="account-tickets.html"><i class="icon-tag"></i>My Tickets<span class="badge badge-primary badge-pill">4</span></a>
                </nav>
            </div>
            <div class="col-lg-8">
                <div class="hidden-lg-up"></div>
                <div class="table-responsive margin-bottom-1x">
                ...
                <!-- Messages-->
                <div class="comment">
                    <div class="comment-author-ava"><img src="assets/images/reviews/01.jpg" alt="Avatar"></div>
                ...
                <div class="comment">
                    <div class="comment-author-ava"><img src="assets/images/reviews/02.jpg" alt="Avatar"></div>
                    <div class="comment-body">
                        <p class="comment-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                ...
                <div class="comment">
                    <div class="comment-author-ava"><img src="assets/images/reviews/03.jpg" alt="Avatar"></div>
                    <div class="comment-body">
                        <p class="comment-text">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                ...
                <!-- Reply Form-->
                <h5 class="mb-30">Leave Message</h5>
                <form method="post">
