...
<head>
    ...
    <title>Pagination | Inspina E-Commerce HTML Template</title>
        ...
        <ul>
            ...
            <li class=" active">
                ...
                <ul class="sub-menu">
                    ...
                    <li class="active"><a href="pagination.html"><i class="fa fa-angle-right"></i> Pagination</a></li>
...
<div class="offcanvas-wrapper">
    ...
    <div class="col-lg-8 col-md-8 offset-lg-2 offset-md-2 padding-bottom-3x">
        <h6 class="text-muted text-normal text-uppercase margin-bottom-1x">Basic Pagination</h6>
        ...
        <h6 class="text-muted text-normal text-uppercase margin-top-1x">Entry Pagination</h6>
        <div class="entry-navigation">
            <div class="column text-left"><a class="btn btn-outline-secondary btn-sm" href="#"><i class="icon-arrow-left"></i> Prev</a></div>
            <div class="column"><a class="btn btn-outline-secondary view-all" href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="All entries"><i class="icon-menu"></i></a></div>
