...
<head>
    ...
    <title>Contact Us | Inspina E-Commerce HTML Template</title>
...
<div class="offcanvas-wrapper">
    ...
    <div class="container padding-top-1x padding-bottom-3x">
        <div class="row">
            ...
            <div class="col-md-5">
                <ul class="list-icon">
                    <li> <i class="fa fa-envelope-o"></i><a class="navi-link" href="#"> customer@Inspina.com</a></li>
                    <li> <i class="fa fa-phone"></i> +1 777 777 7777</li>
                    <li> <i class="fa fa-clock-o"></i> 1 - 2 Business Days</li>
                </ul>
            </div>
        </div>
        ...
        <div class="row margin-top-2x">
            <div class="col-md-7">
                <div class="display-3 text-muted opacity-75 mb-30">Technical Support</div>
            </div>
            <div class="col-md-5">
                <ul class="list-icon">
                    <li> <i class="fa fa-envelope-o"></i><a class="navi-link" href="#"> support@Inspina.com</a></li>
                    <li> <i class="fa fa-phone"></i> +1 888 888 8888</li>
                    <li> <i class="fa fa-clock-o"></i> 2 - 3 Business Days</li>
                </ul>
            </div>
        </div>
        <h3 class="margin-top-3x text-center mb-30">Our Stores Locations</h3>
        <div class="row">
            <div class="col-md-4 col-sm-6">
                <div class="card mb-30">
                    <div class="google-map" data-height="250" data-address="221B Baker Street, London, UK" data-zoom="15" data-disable-controls="true" data-scrollwheel="false" data-marker="assets/images/map-marker.png" data-marker-title="We are here!" data-styles="[{&quot;featureType&quot;:&quot;administrative.country&quot;,&quot;elementType&quot;:&quot;geometry&quot;,&quot;stylers&quot;:[{&quot;visibility&quot;:&quot;simplified&quot;},{&quot;hue&quot;:&quot;#ff0000&quot;}]}]"></div>
                    <div class="card-body">
                        <ul class="list-icon">
                            <li> <i class="icon-map"></i>221B Baker Street, London, UK</li>
                            <li> <i class="icon-bell"></i>+1 777 777 7777</li>
                            <li> <i class="icon-mail"></i><a class="navi-link" href="#">first.store@Inspina.com</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="card mb-30">
                    ...
                    <div class="card-body">
                        <ul class="list-icon">
                            <li> <i class="icon-map"></i>221B Baker Street, London, UK</li>
                            <li> <i class="icon-bell"></i>+1 888 888 8888</li>
                            <li> <i class="icon-mail"></i><a class="navi-link" href="#">second.store@Inspina.com</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6 horizontal-center">
                <div class="card mb-30">
                    <div class="google-map" data-height="250" data-address="221B Baker Street, London, UK" data-zoom="15" data-disable-controls="true" data-scrollwheel="false" data-marker="assets/images/map-marker.png" data-marker-title="We are here!" data-styles="[{&quot;featureType&quot;:&quot;administrative.country&quot;,&quot;elementType&quot;:&quot;geometry&quot;,&quot;stylers&quot;:[{&quot;visibility&quot;:&quot;simplified&quot;},{&quot;hue&quot;:&quot;#ff0000&quot;}]}]"></div>
                    <div class="card-body">
                        <ul class="list-icon">
                            <li> <i class="icon-map"></i>221B Baker Street, London, UK</li>
                            <li> <i class="icon-bell"></i>+1 999 999 9999</li>
                            <li> <i class="icon-mail"></i><a class="navi-link" href="#">third.store@Inspina.com</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<!-- Google Map JS -->
<script src="http://ditu.google.cn/maps/api/js?key=AIzaSyANepSMO56m7Dc5RFutoViWDyqccd2rUmo"></script>
<!-- Gmap JS -->
