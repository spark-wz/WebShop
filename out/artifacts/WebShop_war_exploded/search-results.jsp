...
<head>
    ...
    <title>Search | Inspina E-Commerce HTML Template</title>
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex"><a class="pr-4 hidden-xs-down search-products" href="shop-single-2.html">
                            <img src="assets/images/shop/products/01.jpg" alt="Product"></a>
                            <div>
                                <h5><a class="navi-link" href="shop-single-2.html">iPhone X 32GB </a></h5>
                                <h6>
                                    <del class="text-muted">$799.99</del> $649.99
                                </h6>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex"><a class="pr-4 hidden-xs-down search-products" href="shop-single-2.html">
                            <img src="assets/images/shop/products/02.jpg" alt="Product"></a>
                            <div>
                                <h5><a class="navi-link" href="shop-single-2.html">Samsung Galaxy S8 </a></h5>
                                <h6>
                                    <del class="text-muted">$799.99</del> $699.99
                                </h6>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since ...</p>
                            </div>
                        </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex"><a class="pr-4 hidden-xs-down search-products" href="shop-single-2.html">
                            <img src="assets/images/shop/products/03.jpg" alt="Product"></a>
                            <div>
                                <h5><a class="navi-link" href="shop-single-2.html">Sony Xperia Z5 </a></h5>
                                <h6>
                                    <del class="text-muted">$649.99</del> $549.99
                                </h6>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since ...</p>
                            </div>
                        </div>
            ...
            <div class="col-lg-3 hidden-md-down">
                <aside class="sidebar">
                    ...
                    <!-- Start Promo Banner -->
                    <section class="promo-box search-promo">
